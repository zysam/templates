import { appName, appAuthor, appVersion, appRepo, buildDate } from '@/config';
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap items-center justify-center gap-x-4 gap-y-2 text-xs text-gray-500 dark:text-gray-400">
        ...
        <div className="flex items-center gap-1.5">
          <span>by</span>
          <span className="font-medium text-gray-700 dark:text-gray-300">{appAuthor}</span>
        </div>
        ...
        {appRepo && (
          <>
            ...
            >
              ...
              <span className="group-hover:underline">Repository</span>
            </a>
          </>
        )}
      </div>
      ...
      <div className="text-xs text-gray-400 dark:text-gray-600 text-center">
        Built on {new Date(buildDate).toLocaleDateString('en-US', { 
          year: 'numeric', 
          month: 'short', 
          day: 'numeric' 
        })}
